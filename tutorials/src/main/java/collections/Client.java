...
//        p.status = "Random"; ERROR
        ...
        //Write a new Comparator with age criteria using lambda expression
        Collections.sort(students, (stu1,stu2) -> { //These arguments get's passed as parameters to the `compare` method of the Comparator interface
           if(stu1.age < stu2.age) return -1;
            else if(stu1.age > stu2.age) return 1;
            return 0;
        });
